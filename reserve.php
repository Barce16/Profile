...
<div class="container-form">
    ...
    <form action="profile.php">
        ...
        <div>
            ...
            <hr>
            <a>Plate Number :</a>
            <input type="text"  placeholder="Your Plate Number">
        </div>
        <hr>
        <br>
        <button type="button" onclick="document.location='payment.php'" data-bs-toggle="collapse" data-bs-target="#mynavbar">Proceed
